    ...
    Basic: {
        ...
        map: function() {
            ...
            if($googleMap.length>0) {
                ...
                var image = pickedStyle == 'dark' ? '/etc/designs/my-portfolio/clientlibs/img/location-pin-light.png' : '/etc/designs/my-portfolio/clientlibs/img/location-pin.png';
    ...
    Component: {
        ...
        sectionVideo: function() {
            $('.section-video .btn-play').on('click', function(){
                var video = '<iframe src="' + $(this).attr('href') + '" frameborder="0" autoplay="1" allowfullscreen></iframe>';
